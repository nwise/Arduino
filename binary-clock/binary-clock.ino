...
int second=0, minute=36, hour=19; //start the time on 00:00:00
int munit = 0;
int hunit = 0;
int valm=0;
int valh=0;
...
//  } else  {
  //minutes units 
  if(munit == 1 || munit == 3 || munit == 5 || munit == 7 || munit == 9) {  digitalWrite(1, HIGH);}
  if(munit == 0 || munit == 2 || munit == 4 || munit == 6 || munit == 8) {  digitalWrite(1, LOW);}
  ...
  if(minute >= 40 && minute < 60) {digitalWrite(6, HIGH);} else {digitalWrite(6,LOW);}
